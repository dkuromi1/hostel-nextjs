...
export function PwaInstallButton() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.2em] text-[var(--text-on-surface-dark-muted)]/60 transition-all hover:text-[var(--text-on-surface-dark)]"
