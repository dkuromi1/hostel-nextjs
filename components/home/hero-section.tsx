            ...
            >
              {quickFacts.map((fact, index) => {
                ...
                return (
                  ...
                  >
                    <div className="group relative overflow-hidden rounded-lg border border-white/18 bg-black/40 p-5 backdrop-blur-[3px] transition-all duration-300 hover:border-white/24 hover:bg-black/50">
