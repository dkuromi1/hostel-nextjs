        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <Link
            ...
            className={cn(
              ...
              "bg-gradient-to-br from-[var(--brand-primary)] to-[var(--brand-primary-dark)] text-[var(--primary-foreground)] shadow-lg shadow-[var(--brand-primary)]/20",
              "text-sm font-semibold tracking-tight",
              "transition-all duration-300 hover:shadow-xl hover:shadow-[var(--brand-primary)]/30 hover:-translate-y-0.5",
