  ...
  const factsContent = (
    ...
    >
      {quickFacts.map((fact, index) => {
        ...
        const cardContent = (
          <Panel className="group relative h-full p-card transition-all duration-500 hover:border-[var(--brand-primary)]/30 hover:shadow-xl hover:shadow-[var(--brand-primary)]/5">
