...
export function HeroBookingBar({ className }: { className?: string }) {
  return (
    <div className={cn(
      ...
      <div className="flex flex-col gap-4 overflow-hidden rounded-[32px] border border-white/20 bg-slate-950/40 p-4 shadow-2xl backdrop-blur-3xl md:flex-row md:items-center md:gap-0 lg:p-3">
        {/* Arrive Date */}
        <div className="group flex flex-1 flex-col px-6 py-2 transition-colors hover:bg-white/5 md:border-r md:border-white/10">
          <label className="text-[10px] font-bold uppercase tracking-widest text-emerald-400/80">
            Arrive Date
          </label>
        ...
        <div className="p-1 md:ml-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex h-14 items-center justify-center gap-2 rounded-[24px] bg-emerald-500 px-8 font-heading text-lg font-bold text-slate-950 shadow-[0_10px_25px_-5px_rgba(16,185,129,0.5)] transition-all hover:scale-[1.02] hover:bg-emerald-400 active:scale-95 md:h-16"
          >
            Check Availability
          </a>
        </div>
