      ...
      <div className="flex flex-col gap-4 overflow-hidden rounded-[32px] border border-white/20 bg-[var(--surface-dark)]/40 p-4 shadow-2xl backdrop-blur-3xl md:flex-row md:items-center md:gap-0 lg:p-3">
        ...
        <div className="p-1 md:ml-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex h-14 items-center justify-center gap-2 rounded-[24px] bg-[var(--brand-primary)] px-8 font-heading text-lg font-bold text-[var(--primary-foreground)] shadow-[0_10px_25px_-5px_rgba(196,92,42,0.5)] transition-all hover:scale-[1.02] hover:bg-[var(--brand-primary-dark)] active:scale-95 md:h-16"
          >
            Check Availability
          </a>
        </div>
