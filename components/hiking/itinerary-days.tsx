          ...
          <Reveal key={day.day} delay={i * 100}>
            <Panel className="flex h-full flex-col p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="relative mb-8 flex w-full items-center justify-center">
                <div className="absolute left-0 inline-flex rounded-full bg-[var(--brand-primary)]/10 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-[var(--brand-primary-dark)]">
                  {day.day}
                </div>
