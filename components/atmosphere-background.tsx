...
export function AtmosphereBackground() {
  ...
  const noiseUrl = `url("data:image/svg+xml,%3Csvg viewBox='0 0 140 140' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='1' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)' opacity='0.18'/%3E%3C/svg%3E")`;
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: isLowEnd ? gradients.join(",") : `${noiseUrl}, ${gradients.join(",")}`,
        backgroundSize: isLowEnd
          ? "100% 100%, 100% 100%, 100% 100%, 100% 100%, 140px 140px, 140px 140px"
          : "140px 140px, 100% 100%, 100% 100%, 100% 100%, 100% 100%, 140px 140px, 140px 140px",
        backgroundRepeat: isLowEnd
          ? "no-repeat, no-repeat, no-repeat, no-repeat, repeat, repeat"
          : "repeat, no-repeat, no-repeat, no-repeat, no-repeat, repeat, repeat",
        backgroundBlendMode: isLowEnd ? "normal" : "overlay, normal, normal, normal, normal, normal, normal",
