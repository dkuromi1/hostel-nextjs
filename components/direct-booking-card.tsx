      ...
      <div className={cn(
        ...
        <a
          ...
          className={cn(
            ...
            "shrink-0 w-full sm:w-auto rounded-full bg-[var(--brand-primary)] px-7 font-semibold text-[var(--primary-foreground)] transition-all duration-300 hover:bg-[var(--brand-primary-dark)] active:scale-95"
          )}
        >
    ...
    <div className={cn("glass-panel rounded-[28px] p-5", className)}>
      ...
      <a
        ...
        className={cn(
          ...
          "mt-4 w-full rounded-full bg-[var(--brand-primary)] font-semibold text-[var(--primary-foreground)] transition-all duration-300 hover:bg-[var(--brand-primary-dark)] active:scale-95"
        )}
      >
        {content.directBookingButton}
      </a>
