...
export function DirectBookingCard({
  ...
  if (variant === "inline") {
    return (
      <div className={cn(
        "group relative flex flex-col sm:flex-row items-center justify-between glass-panel rounded-[var(--radius-3xl)] p-card gap-8 w-full overflow-hidden transition-all duration-500 hover:border-[var(--brand-primary)]/30 hover:shadow-xl hover:shadow-[var(--brand-primary)]/5",
        className
      )}>
        ...
        <a
          ...
          className={cn(
            ...
            "relative z-10 shrink-0 w-full sm:w-auto h-14 rounded-[var(--radius-full)] px-8 text-base font-semibold tracking-tight transition-all duration-500 hover:scale-[1.05] shadow-whatsapp active:scale-95"
          )}
        >
  ...
  return (
    <div className={cn(
      "group relative glass-panel rounded-[var(--radius-3xl)] p-card overflow-hidden transition-all duration-500 hover:border-[var(--brand-primary)]/30 hover:shadow-xl hover:shadow-[var(--brand-primary)]/5",
      className
    )}>
      {/* Decorative Background Elements */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-[0.03] soft-grid" />
      ...
      <a
        ...
        className={cn(
          buttonVariants({ variant: "whatsapp" }),
          "relative z-10 mt-8 w-full h-12 rounded-[var(--radius-full)] px-10 text-[16px] font-semibold tracking-tight transition-all duration-500 hover:scale-[1.03] shadow-whatsapp active:scale-95"
        )}
      >
        {content.directBookingButton}
      </a>
